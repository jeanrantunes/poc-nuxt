const stories = ['../../components/**/*.stories.@(ts|js)','../../stories/**/*.stories.@(js|mdx)']
const addons  = ["@storybook\u002Faddon-essentials","@storybook\u002Faddon-controls","@storybook\u002Faddon-notes",(function(a){return {name:"@storybook\u002Faddon-storysource",options:{rule:{include:["\u002FUsers\u002Fhenriquemarba\u002FProjects\u002FPossible\u002Fsrc"]},loaderOptions:{prettierConfig:{printWidth:80,singleQuote:a},injectStoryParameters:a}}}}(false)),{name:"@storybook\u002Faddon-docs",options:{sourceLoaderOptions:{injectStoryParameters:false}}}]
